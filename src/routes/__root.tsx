  ...
  head: () => ({
    meta: [
      ...
      { title: "AOCC — Airport Operations Control Center" },
      {
        name: "description",
        content:
          "Real-time airport operations control center unifying flights, gates, baggage, security, maintenance, staff and retail into one live picture.",
      },
      { property: "og:title", content: "AOCC — Airport Operations Control Center" },
      {
      ...
      { name: "twitter:site", content: "@AOCC" },
    ],
    links: [
      {
        rel: "stylesheet",
